...
export function UploadPanel({ lessonId, lessonPartId, kind }: { lessonId: string; lessonPartId?: string; kind: UploadKind }) {
  ...
  const label = kind === "video" ? "فيديو الدرس" : "ملزمة الدرس";
