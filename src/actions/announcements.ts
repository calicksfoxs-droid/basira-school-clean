...
export async function createAnnouncementAction(formData: FormData) {
  ...
  try {
    ...
    const parsed = announcementSchema.parse({ targetType: formText(formData, "targetType"), groupId: formText(formData, "groupId") || undefined, title: formText(formData, "title"), body: formText(formData, "body"), ctaLabel: formText(formData, "ctaLabel") || undefined, ctaPath: formText(formData, "ctaPath") || undefined });
